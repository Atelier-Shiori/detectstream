...
@protocol OmniWebGenericMethods
...
// A scriptable object.
@interface OmniWebItem : SBObject <OmniWebGenericMethods>
...
+ (OmniWebApplication *) application;

- (SBElementArray<OmniWebDocument *> *) documents;
- (SBElementArray<OmniWebWindow *> *) windows;
...
- (SBElementArray<OmniWebAttachment *> *) attachments;
- (SBElementArray<OmniWebAttributeRun *> *) attributeRuns;
- (SBElementArray<OmniWebCharacter *> *) characters;
- (SBElementArray<OmniWebParagraph *> *) paragraphs;
- (SBElementArray<OmniWebWord *> *) words;
...
- (SBElementArray<OmniWebBookmarksDocument *> *) bookmarksDocuments;
- (SBElementArray<OmniWebBrowser *> *) browsers;
- (SBElementArray<OmniWebWorkspace *> *) workspaces;
...
- (SBElementArray<OmniWebBookmark *> *) bookmarks;
...
- (SBElementArray<OmniWebTab *> *) tabs;
...
@interface OmniWebPrintSettings : SBObject <OmniWebGenericMethods>
